    ...
    <div id="footer" className="footer">
      ...
      <div className="footer-right">
        ...
        <div className="footer-column">
          <h4>Folow Us On</h4>
          <ul>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">GitHub</a></li>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">X</a></li>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">Telegram</a></li>
          </ul>
        </div>
      </div>
    </div>
