...
const Mission = () => {
  return (
    <section className="mission">
      ...
      We aim to create a reliable marketplace where students can easily find and sell essentials — from gadgets and books to everyday needs — all in one trusted platform designed specifically for our needs and budgets.
      </p>
    </section>
  );
};
