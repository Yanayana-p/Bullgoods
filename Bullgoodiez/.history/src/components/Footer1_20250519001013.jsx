    ...
    <div id="footer" className="footer">
      ...
      <div className="footer-right">
        <div className="footer-column">
          <h4>Who We Serve</h4>
          <ul>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">Students</a></li>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">Community</a></li>
            <li><a href="https://national-u.edu.ph/" target="_blank" rel="noopener noreferrer">Small Business</a></li>
          </ul>
        </div>
