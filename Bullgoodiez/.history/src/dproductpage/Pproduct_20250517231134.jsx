...
const sampleProducts = [
  ...
  { id: 8, name: 'Phone charm', price: 75, description: 'Selling phone charm guys, marami akong design. Di kayo luge rito. Sa iba 150 pa to. ', image: '/product8.jpg' },
  { id: 9, name: 'Drawing pad', price: 20000, description: 'For sale! Never been use kasi hiniwalayan ako nung pagbibigyan ko. Di naman ako marunong mag-drawing. Bilhin niyo na para may pang tuition ako. Ibato ko na lang to.', image: '/product9.jpg' },
  { id: 10, name: 'Spotify Premium', price: 125, description: 'Selling a pro access to Canva for a very affordable price. This is a share account kung maarte, wag na mag-message. Thank u!', image: '/product10.jpg' },
];
