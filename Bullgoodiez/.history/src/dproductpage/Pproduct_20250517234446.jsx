...
const sampleProducts = [
  ...
  { id: 10, name: 'Spotify Premium', price: 125, description: 'Pagod ka na ba mag-commute? Avail ka na para di ka na pagod. May libreng dalawang kiss pag nag-avail. Limited offer (yung !', image: '/product10.jpg' },
];
