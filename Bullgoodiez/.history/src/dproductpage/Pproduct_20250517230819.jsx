...
const sampleProducts = [
  ...
  { id: 6, name: 'Pasta in a Box', price: 150, description: 'Hi guyzz, bili na kayo, nasa school ako mon-fri. Sa garden na lang pick-up. Dm me for reservation. No cancellation, ako magca-cancel sainyo!', image: '/product5.jpg' },
  ...
  { id: 8, name: 'Phone charm', price: 75, description: 'Selling a pro access to Canva for a very affordable price. This is a share account kung maarte, wag na mag-message. Thank u!', image: '/product5.jpg' },
  { id: 9, name: 'Drawing pad', price: 20000, description: 'Selling a pro access to Canva for a very affordable price. This is a share account kung maarte, wag na mag-message. Thank u!', image: '/product5.jpg' },
  { id: 10, name: 'Spotify Premium', price: 125, description: 'Selling a pro access to Canva for a very affordable price. This is a share account kung maarte, wag na mag-message. Thank u!', image: '/product5.jpg' },
];
