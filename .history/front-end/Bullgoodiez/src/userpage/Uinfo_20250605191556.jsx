  ...
  return (
    <div className="profile-layout">
      ...
      <div className="profile-content-container">
        ...
        {/* Right side: Non-editable info list */}
        <div className="user-info-list">
          <h3>Account Information</h3>
          <ul>
            <li><strong>Role:</strong> {user.role || "N/A"}</li>
            <li><strong>Member Since:</strong> January 2023</li> {/* Replace with real data if available */}
            <li><strong>Last Login:</strong> June 4, 2025</li> {/* Replace with real data if available */}
            <li><strong>Notifications:</strong> 5</li> {/* Example static data */}
            <li><strong>Pending Orders:</strong> 3</li> {/* Example static data */}
          </ul>
        </div>
      </div>
